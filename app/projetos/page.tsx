import { Activity, Flower2, Sun, Users } from "lucide-react";
...
const projects = [
  ...
  { href: "/projetos/firmando-os-trabalhos", title: "Firmando os trabalhos", label: "Rede de apoio", Icon: Users },
  { href: "/projetos/pao-solidario", title: "Pão solidário da Vó Margarida", label: "Ação comunitária", Icon: Sun },
] as const;
