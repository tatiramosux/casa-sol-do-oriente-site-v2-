...
type Cat =
  "giras" | "cursos" | "apometria" | "social" | "commemorative" | "noGira";
type Item = {
  id: string;
  title: string;
  start: string;
            ...
            {selected && (
              <Dialog.Portal forceMount>
                ...
                <Dialog.Content asChild aria-describedby="description">
                  ...
                  >
                    <i className={`accent ${cats[selected.category].color}`} />
                    <Dialog.Close className="close" aria-label="Fechar">
                      <X />
                    </Dialog.Close>
                    <div className="dialog-title">
                      <span className={`icon ${cats[selected.category].color}`}>
                        {(() => {
                    ...
                    {accessFor(selected) && (
                      <b
                        className={`badge ${accessFor(selected)?.important ? "closed" : "public"}`}
                      >
...
function EventCard({
  ...
  return (
    <motion.button
      ...
      className={`${mobile ? "mobile-event" : "event"} ${cat.color} ${past ? "past-event" : ""}`}
      onClick={onClick}
    >
